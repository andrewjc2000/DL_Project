...
with torch.no_grad():
    print("calculating train velocity")
    ...
    np.save('train_velocity_'+thresh+'.npy', train_velocity)
    print('train_velocity_'+thresh+'.npy')
...
# np.save('test_ucsd_velocity.npy', test_velocity)